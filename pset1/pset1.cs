// Dafny program pset1.dfy compiled into C#
...
// Command-line arguments: run pset1.dfy
// pset1.dfy
...
module Pset1 {
  ...
  method SeqMin(s: seq<int>) returns (m: int)
    requires |s| > 0
    ensures m in s
    ensures forall i: int {:trigger s[i]} :: 0 <= i < |s| ==> m <= s[i]
    decreases s
  {
    assert forall v: int {:trigger v in s[1..]} {:trigger v in s} :: v in s ==> v == s[0] || v in s[1..];
    if |s| == 1 {
      m := s[0];
    } else {
      var m' := SeqMin(s[1..]);
  ...
  method Reverse(s: seq<int>) returns (r: seq<int>)
    ensures |r| == |s|
    ensures forall i: int {:trigger r[i]} :: 0 <= i < |r| ==> r[i] == s[|s| - 1 - i]
    decreases s
  {
    if |s| == 0 {
      r := [];
  ...
  method SeqToMap(s: seq<int>) returns (m: map<int, int>)
    ensures forall i: int {:trigger i in m.Keys} :: (i in m.Keys ==> 0 <= i) && (i in m.Keys ==> i < |s|)
    ensures forall i: int {:trigger i in m.Keys} :: 0 <= i < |s| ==> i in m.Keys
    ensures forall i: int {:trigger s[i]} {:trigger m[i]} :: 0 <= i < |s| ==> m[i] == s[i]
    decreases s
  {
    if |s| == 0 {
      m := map[];
...
namespace Pset1 {
  ...
  public partial class __default {
    ...
    public static BigInteger SeqMin(Dafny.ISequence<BigInteger> s)
    {
      BigInteger m = BigInteger.Zero;
      if ((new BigInteger((s).Count)) == (BigInteger.One)) {
        m = (s).Select(BigInteger.Zero);
      } else {
        BigInteger _0_m_k;
        BigInteger _out0;
        _out0 = Pset1.__default.SeqMin((s).Drop(BigInteger.One));
        _0_m_k = _out0;
        if ((_0_m_k) < ((s).Select(BigInteger.Zero))) {
          m = _0_m_k;
        } else {
          m = (s).Select(BigInteger.Zero);
        }
    ...
    public static BigInteger SeqMax(Dafny.ISequence<BigInteger> s)
    {
      BigInteger m = BigInteger.Zero;
      if ((new BigInteger((s).Count)) == (BigInteger.One)) {
        m = (s).Select(BigInteger.Zero);
        ...
        BigInteger _0_m_k;
        BigInteger _out0;
        _out0 = Pset1.__default.SeqMax((s).Drop(BigInteger.One));
        _0_m_k = _out0;
        if ((_0_m_k) > ((s).Select(BigInteger.Zero))) {
          m = _0_m_k;
        } else {
    ...
    public static Dafny.ISequence<BigInteger> Reverse(Dafny.ISequence<BigInteger> s)
    {
      Dafny.ISequence<BigInteger> r = Dafny.Sequence<BigInteger>.Empty;
      if ((new BigInteger((s).Count)).Sign == 0) {
        r = Dafny.Sequence<BigInteger>.FromElements();
      } else {
        Dafny.ISequence<BigInteger> _0_r_k;
        Dafny.ISequence<BigInteger> _out0;
        _out0 = Pset1.__default.Reverse((s).Drop(BigInteger.One));
        _0_r_k = _out0;
        r = Dafny.Sequence<BigInteger>.Concat(_0_r_k, Dafny.Sequence<BigInteger>.FromElements((s).Select(BigInteger.Zero)));
      }
      return r;
    }
    public static Dafny.IMap<BigInteger,BigInteger> SeqToMap(Dafny.ISequence<BigInteger> s)
    {
      Dafny.IMap<BigInteger,BigInteger> m = Dafny.Map<BigInteger, BigInteger>.Empty;
      if ((new BigInteger((s).Count)).Sign == 0) {
        m = Dafny.Map<BigInteger, BigInteger>.FromElements();
      } else {
        Dafny.IMap<BigInteger,BigInteger> _0_m_k;
        Dafny.IMap<BigInteger,BigInteger> _out0;
        _out0 = Pset1.__default.SeqToMap((s).Take((new BigInteger((s).Count)) - (BigInteger.One)));
        _0_m_k = _out0;
        m = Dafny.Map<BigInteger, BigInteger>.Update(_0_m_k, (new BigInteger((s).Count)) - (BigInteger.One), (s).Select((new BigInteger((s).Count)) - (BigInteger.One)));
      }
      return m;
    }
  }
} // end of namespace Pset1
namespace _module {
